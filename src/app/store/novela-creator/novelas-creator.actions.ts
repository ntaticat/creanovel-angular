...
export const SET_NOVELA_SUCCESS = createAction(
  '[Novelas Creator] SET_NOVELA_SUCCESS',
  props<{ payload: INovela }>()
);

export const SET_NOVELA_ERROR = createAction(
  '[Novelas Creator] SET_NOVELA_ERROR',
  props<{ payload: any }>()
);
